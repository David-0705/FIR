...
// Complete translations for chatbot messages
export const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    errorMessage: "I'm sorry, there was an error processing your message. Please try again.",
  ...
  hi: {
    ...
    errorMessage: "क्षमा करें, संदेश संसाधित करने में त्रुटि हुई। कृपया फिर से कोशिश करें।",
  ...
  mr: {
    ...
    errorMessage: "क्षमा करा, संदेश प्रक्रिया करण्यात त्रुटी झाली. कृपया पुन्हा प्रयत्न करा.",
...
export const getTranslation = (key: string, language: LanguageCode, variables?: Record<string, string>): string => {
